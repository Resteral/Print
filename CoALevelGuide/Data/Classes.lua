...
CoALevelGuide_Classes = {
    ...
    },
    {
        ...
        specs = {
            { name = "Inscription", role = "Tank", description = "Defensive spec using protective runes to absorb and reflect damage." },
            { name = "Runic Fury", role = "DPS", description = "Aggressive melee spec channeling elemental rune power into weapon strikes." },
            { name = "Arcane Binding", role = "DPS/CC", description = "Control spec using binding runes to immobilize, silence, and drain enemies." },
        },
        levelingTips = {
            "Leveling Spec: Runic Fury for consistent melee output with elemental procs.",
            "Priority Stats: Strength > Stamina > Spell Damage (Runic Fury).",
            ...
            "Inscription spec makes you nearly unkillable — great for dangerous elite zones.",
            "Arcane Binding's silence is invaluable against caster mobs — use it proactively.",
            "Dungeon Role: Tank with Inscription, burst DPS with Runic Fury.",
        },
